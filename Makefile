...
.PHONY: build bpf test fmt vet selftest selftest-multivip selftest-weighted selftest-ratelimit selftest-ipv6 selftest-ndp selftest-restart selftest-adopt selftest-drops selftest-xdpmode selftest-httpcheck selftest-apiauth selftest-affinity selftest-vipratelimit selftest-portrange selftest-all \
...
selftest-all: selftest selftest-multivip selftest-weighted selftest-ratelimit selftest-ipv6 selftest-ndp selftest-restart selftest-adopt selftest-drops selftest-xdpmode selftest-httpcheck selftest-apiauth selftest-affinity selftest-vipratelimit selftest-portrange
